mport MetadataViews from "../../contracts/MetadataViews.cdc"
import ImsaNFT from "../../contracts/ImsaNFT.cdc"
...
pub fun main(address: Address, id: UInt64): NFT {
    ...
    let collection = account
        .getCapability(ImsaNFT.CollectionPublicPath)
        .borrow<&{ImsaNFT.ImsaNFTCollectionPublic}>()
        ?? panic("Could not borrow a reference to the collection")

    let nft = collection.borrowImsaNFT(id: id)!
